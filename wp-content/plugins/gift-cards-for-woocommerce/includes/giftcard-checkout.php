...
if ( ! function_exists( 'rpgc_checkout_form' ) ) {
	...
	function rpgc_checkout_form() {
		...
		if( get_option( 'woocommerce_enable_giftcard_checkoutpage' ) == 'yes' ){
			...
			$info_message = apply_filters( 'woocommerce_checkout_giftcard_message', __( 'Vous avez une carte cadeau?', 'rpgiftcards' ) . ' <a href="#" class="showgiftcard">' . __( 'Cliquer ici pour entrer votre code', 'rpgiftcards' ) . '</a>' );
