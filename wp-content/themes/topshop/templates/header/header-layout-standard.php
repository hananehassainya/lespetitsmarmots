    ...
    <div class="site-header-right">
        ...
        if ( topshop_is_woocommerce_activated() ) { ?>
            ...
            <?php if ( is_user_logged_in() ) { ?>
                <div class="site-header-right-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Mon Compte','topshop'); ?>"><?php _e('Mon Compte','topshop'); ?></a></div>
            <?php } else { ?>
                <div class="site-header-right-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Se Connecter','topshop'); ?>"><?php _e('Se Connecter / S\'enregister','topshop'); ?></a></div>
            <?php } ?>
